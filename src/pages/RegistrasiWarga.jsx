        ...
        <div className="bg-white p-8 rounded-xl shadow-md">
            ...
            <form onSubmit={handleSubmit} className="space-y-8">
                <FormSection title="Data Diri & Dokumen">
                    <InputField label="Nama Lengkap (sesuai KTP)" name="namaLengkap" value={formData.namaLengkap} onChange={handleInputChange} placeholder="Nama Lengkap" />
